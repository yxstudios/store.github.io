const ThemeManager = {
    ...
    applyTheme(theme) {
        ...
        if (logoImg && THEME_LOGOS[theme]) logoImg.src = THEME_LOGOS[theme];
    },
    setupListeners() {
        document.querySelectorAll('.theme-option').forEach(btn => btn.addEventListener('click', () => this.applyTheme(btn.dataset.theme)));
    }
};
